...
\usepackage[top=2.5cm, bottom=2.5cm, right=2.5cm, left=3.5cm]{geometry}  %okraje
...
\def\nazov{Tvorba príbehov v počítačových hrách}
\def\autor{Tomáš Bakoš}
